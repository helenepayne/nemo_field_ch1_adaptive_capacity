...
#Read in the data
BB_22 <- read_csv(here::here("data/compiled_sheets/BB_compiledsheet_full_2022.csv")) 
...
#save it
write.csv(BB_22, "processed_data/BB_22.csv", row.names = FALSE)
```
...
write.csv(bhat.Donor.mu, "processed_data/BB22_bhat.Donor.mu.csv")
...
BB_23 <- read_csv(here::here("data/compiled_sheets/BB_compiledsheet_full_2023.csv")) 
...
write.csv(bhat.donor.mu, "processed_data/BB23_bhat.Donor.mu.csv")
```
